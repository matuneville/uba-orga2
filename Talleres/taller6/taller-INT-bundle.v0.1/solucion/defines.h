...
#define GDT_CODE_0_SEL  ((uint16_t)(GDT_IDX_CODE_0 << 3) + (uint16_t)(0)) 
#define GDT_DATA_0_SEL  ((uint16_t)(GDT_IDX_DATA_0 << 3) + (uint16_t)(0))
#define GDT_CODE_3_SEL  ((uint16_t)(GDT_IDX_CODE_3 << 3) + (uint16_t)(3)) 
#define GDT_DATA_3_SEL  ((uint16_t)(GDT_IDX_DATA_3 << 3) + (uint16_t)(3))
// 00000000110000
...
#define FLAT_SEGM_SIZE   817 * 1024 * 1024 // esto lo hice asumiendo unidad Bytes
#define VIDEO_SEGM_SIZE  50 * 80 * 2  // 50x80 columnas, cada celda 2 Bytes
