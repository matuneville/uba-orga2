...
typedef struct str_gdt_descriptor {
  uint16_t gdt_length;
  uint32_t gdt_addr; // direccion donde encontramos la tabla 
...
extern gdt_entry_t gdt[]; // define un array de un segment descriptor vacio
extern gdt_descriptor_t GDT_DESC; // define una gdt
