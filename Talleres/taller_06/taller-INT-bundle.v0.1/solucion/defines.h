...
#define GDT_CODE_0_SEL (0) | (0 << 2) | (GDT_IDX_CODE_0 << 3)  // 0000 0000 0000 1000
#define GDT_DATA_0_SEL (0) | (0 << 2) | (GDT_IDX_DATA_0 << 3)
#define GDT_CODE_3_SEL (3) | (0 << 2) | (GDT_IDX_CODE_3 << 3) 
#define GDT_DATA_3_SEL (3) | (0 << 2) | (GDT_IDX_DATA_3 << 3) 
...
#define DESC_TYPE_READ_WRITE (1+1)
