...
MMU_ENTRY_PADDR(X)  devuelve la dirección física de la base de un page frame o de un page table, x es el campo de 20 bits en una PTE o PDE
*/

#define VIRT_PAGE_OFFSET(X)     (X & 0x00000FFF)          // 0000 0000 0000 0000 0000 1111 1111 1111
#define VIRT_PAGE_TABLE(X)      ((X & 0x003FF000) >> 12)  // 0000 0000 0011 1111 1111 0000 0000 0000
#define VIRT_PAGE_DIR(X)        ((X & 0xFFC00000) >> 22)  // 1111 1111 1100 0000 0000 0000 0000 0000
