...
_isr32:
    ...
    ; aviso que ya se atendio la interrupcion
    call pic_finish1

    ; epilogo
    popad
    iret ; return con eflags
...
_isr33:
    ...
    ; paso parametro por pila
    push eax
    call process_scancode
    ; restauro alineamiento pila?
    pop eax ; o add rsp, 4 ?
...
; COMPLETAR: Implementar la rutina
_isr88:
    ; pushad : No hacemos pushad, ya que eax es uno de los registros pusheados (abajo el orden)
    ;           entonces al hacer popad, se restauraria el valor
