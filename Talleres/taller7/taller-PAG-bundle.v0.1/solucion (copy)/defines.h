...
#define VIRT_PAGE_OFFSET(X) (X & 0x00000FFF) // aplico mascaras como arriba
#define VIRT_PAGE_TABLE(X)  ((X >> 12) & 0x000003FF)
#define VIRT_PAGE_DIR(X)  ((X >>  22) &  0x000003FF)

#define CR3_TO_PAGE_DIR(X)  (X & 0xFFFFF000) // saco 12 bits bajos
